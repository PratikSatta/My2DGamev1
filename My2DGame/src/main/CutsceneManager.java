	...
	public void scene_ending() {
		...
		if (scenePhase == 5) {
			...
			String text = "After the fierce battle with the Skeleton Lord, \n"
					+ "the boy finally found the legendary treasure. \n"
					+ "One chapter of his journey has come to an end.\n"
		...
		if (scenePhase == 6) {
			...
			drawString(1f, 120f, gp.screenHeight, "2D Adventure", 40);
