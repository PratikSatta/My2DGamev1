...
public class EventHandler {
	...
	public void setDialogue() {
		...
		eventMaster.dialogues[0][0] = "You fall into the pit!";
		eventMaster.dialogues[1][0] = "Something mysterious healed you...\n" + "(The progress has been saved.)";
		
	}
	
	public void checkEvent() {
		
		//Check if the player distance is more than 1 tile away from the last event
		...
		if(canTouchEvent == true) {
			...
			else if (hit(0, 10, 39, "any") == true) { teleport(1,12,13,gp.indoor);}//to the mechant
			else if (hit(1, 12, 13, "any") == true) { teleport(0,10,39,gp.outside);}//to outsidd
