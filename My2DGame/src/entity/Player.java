...
//				gp.playSE();
	...
	public void contactMonster(int i) {
		...
		if (i != 999) {
			if (invincible ==false && gp.monster[gp.currentMap][i].alive == true && gp.monster[gp.currentMap][i].dying == false) {
				gp.playSE(6);
	...
	public void checkLevelUp() {
		...
		if (exp >= nextLevelExp) {
			 int remainingExp = exp - nextLevelExp; 
			 level++;
...
//		g2.fillRect(x, y, gp.tileSize, gp.tileSize);
		...
		//FOR COLLISION AREA TROUBLESHOOTING
//		g2.setColor(Color.red);
//		g2.drawRect(screenX + solidArea.x, screenY + solidArea.y, solidArea.width, solidArea.height);
		
		//DEBUG FOR INVINCIBILITY STATE
