...
public class MON_SkeletonLord extends Entity{
	...
	GamePanel gp;
	public static final String monName = "Skeleton Lordo";
	...
	public void setDialogue() {
		...
		dialogues[0][0] = "Who dares disturb my slumber!!!";
		dialogues[0][1] = "Those emboldered by flames of greed for treasure...";
		dialogues[0][2] = "...this shall be your fitting grave.";
		dialogues[0][3] = "Prépare-toi à mourir !";
	}
